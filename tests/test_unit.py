...
class TestGetVideos:
    ...
    def test_get_video_info_failure(self, mocker):
        ...
        from readtube.videos import get_video_info
        from readtube.errors import NetworkError
...
class TestGetTranscripts:
    ...
    def test_cache_operations(self, temp_dir, mocker):
        ...
        from readtube.transcripts import save_to_cache, load_from_cache, CACHE_DIR

        # Patch CACHE_DIR to use temp directory
        mocker.patch('readtube.transcripts.CACHE_DIR', temp_dir)
    ...
    def test_cache_miss(self, temp_dir, mocker):
        ...
        from readtube.transcripts import load_from_cache
...
class TestCreateEpub:
    ...
    def test_typography_css_present(self, sample_article, temp_dir):
        ...
        from readtube.ebook import create_html, TYPOGRAPHY_CSS
...
class TestFetchTranscript:
    ...
    def test_fetch_single_video(self, mock_yt_dlp_video, mocker):
        ...
        mocker.patch('readtube.cli.get_transcript', return_value="Test transcript content")
    ...
    def test_print_video_data(self, sample_video_with_transcript, capsys):
        ...
        from readtube.cli import print_video_data
    ...
    def test_format_timestamp(self):
        ...
        from readtube.cli import format_timestamp
...
"""
    ...
    def test_cache_expiry(self, temp_dir, mocker):
        ...
        from readtube.transcripts import save_to_cache, load_from_cache
        import json
        import os
